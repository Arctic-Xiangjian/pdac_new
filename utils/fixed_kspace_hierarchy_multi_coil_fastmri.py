...
DEFAULT_OUTPUT_PREFIX = (
    Path(__file__).resolve().parent / "gamma_fastmri_multicoil_384_raw"
)
DEFAULT_TMP_DIR = "/tmp/cov_rank_fastmri_multicoil_384"


def build_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Compute raw fixed k-space hierarchy statistics for fastMRI multi-coil data."
    )
