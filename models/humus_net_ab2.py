...
class HUMUSNetAB2(nn.Module):
    """Stanford2D ablation 2: no condition injection, keep mask projection."""
...
class VarNetBlockNoCondition(nn.Module):
    ...
    def forward(
        ...
        restore_im = self.apply_model(self.sens_reduce(current_kspace, sens_maps))
